Tommycoin Core version *0.15.1* is now available from:

  <https://download.tommycoin.org/tommycoin-0.15.1/>
...
A number of changes to the way Tommycoin Core deals with peer connections and invalid blocks
...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 kegs per kB (0.00001 TMMY). This is to prepare for dropping the minimum transaction fee to 0.1 kegs per kB (0.0001 TMMY) in the next release.
