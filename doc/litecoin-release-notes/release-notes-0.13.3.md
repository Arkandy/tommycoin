Tommycoin Core version 0.13.3 is now available from:

  <https://download.tommycoin.org/tommycoin-0.13.3/>
...
Developers who require the new testnet blockchain paramaters can find them [here](https://github.com/tommycoin-project/tommycoin/blob/0.13/src/chainparams.cpp#L214).
