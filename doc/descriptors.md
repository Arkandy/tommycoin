# Support for Output Descriptors in Tommycoin Core

Since Tommycoin Core v0.17, there is support for Output Descriptors. This is a
...
on Tommycoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Tommycoin Core wallets, a convenience function `combo` is
