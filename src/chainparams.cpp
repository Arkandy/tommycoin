...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.tommycoin.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.tommycointools.com");
        vSeeds.emplace_back("dnsseed.tommycoinpool.org");
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.tommycointools.com");
        vSeeds.emplace_back("seed-b.tommycoin.loshan.co.uk");
