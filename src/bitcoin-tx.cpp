...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " tommycoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  tommycoin-tx [options] <hex-tx> [commands]  Update hex-encoded tommycoin transaction\n" +
            "or:     tommycoin-tx [options] -create [commands]   Create hex-encoded tommycoin transaction\n" +
            "\n";
