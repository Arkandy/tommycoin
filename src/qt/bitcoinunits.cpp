...
QString BitcoinUnits::longName(int unit)
{
    switch(unit)
    {
    case BTC: return QString("TMMY");
    case mBTC: return QString("kegs");
    case uBTC: return QString("pints");
    case SAT: return QString("chasers");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("Tommycoins");
