...
"""Verify that starting tommycoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start tommycoin with -h for help text")
        ...
        self.log.info("Start tommycoin with -version for version information")
        ...
        self.log.info("Start tommycoind with -fakearg to make sure it does not start")
